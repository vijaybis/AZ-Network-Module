...
def create_pool_with_azure_cli(config: Dict[str, Any]) -> bool:
    ...
    autoscale_formula = (
        ...
        "// The pool size is capped at 5, if target VM value is more than that, set it to 5. This value should be adjusted according to your use case.\n"
        "cappedPoolSize = 5;\n"
